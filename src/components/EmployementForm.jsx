...
const Form = () => {
  return (
    <form>
      <div className="space-y-12 mx-auto max-w-7xl px-4 py-24 sm:px-6 sm:py-32 lg:px-8">
        ...
        <div className="mt-6 flex items-center justify-end gap-x-6">
          <button
            type="submit"
            className="rounded-md bg-[#c18b2e] px-3 py-2 text-sm font-semibold text-black shadow-sm hover:bg-[#c18b2e] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#c18b2e]"
          >
            Submit
          </button>
        </div>
