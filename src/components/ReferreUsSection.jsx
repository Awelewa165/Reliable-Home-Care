  ...
  return (
    <div class="min-h-screen bg-[#F6F6F6] mt-[50px] py-6 flex flex-col justify-center sm:py-12">
      ...
      <div class="relative py-3 mt-8 sm:max-w-xl sm:mx-auto">
        <div class="absolute inset-0 bg-gradient-to-r from-[#c18b2e] to-[#c18b2e] shadow-lg transform -skew-y-6 sm:skew-y-0 sm:-rotate-6 sm:rounded-3xl"></div>
        <div class="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
          <div class="max-w-md mx-auto">
            <div>
              <h1 class="text-2xl font-semibold">Submit your referrals</h1>
              <p className="mt-2 text-[#c18b2e]">
                {" "}
            ...
            <div class="divide-y divide-gray-200">
              <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                ...
                <div class="relative">
                  <button class="bg-[#c18b2e] text-white rounded-md px-2 py-1">
                    Submit
                  </button>
                </div>
              </div>
